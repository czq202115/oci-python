...
config_file = "<填入api配置文件位置，如：config.txt>"
...
print('All files downloaded and extracted.'+ str(n) )

# 处理文件
merged_file_path = os.path.join(out_path, 'merged_report.csv')
...
print('已用:{}GB'.format(sum_quantity/1024/1024/1024))
